...
logger = logging.getLogger(__name__)  # <--- Add parentheses
table = "yt_api"
...
def staging_table():
    ...
    try:
        ...
        logger.info(f"An error occoured during the update of {schema} table: {e}")
        raise e
    ...
    try:
        ...
        for row in rows:
            ...
            if len(table_ids) == 0:
                ...
                insert_rows(cur, conn, schema, transform_data(row))
